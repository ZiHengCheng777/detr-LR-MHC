...
class WarmupMultiStepLR(MultiStepLR):
    ...
    def __init__(
        ...
        for param_group in optimizer.param_groups:
            ...
            param_group["warmup_initial_lr"] = 0.0 if target_lr == 0 else initial_lr
            param_group["warmup_diff"] = target_lr - param_group["warmup_initial_lr"]
        ...
        if self.warmup_steps > 0 and self.last_epoch <= self.warmup_steps:
            ...
            for param_group, base_lr in zip(self.optimizer.param_groups, self.base_lrs):
                if base_lr == 0:
                    ...
                    continue
                new_lr = (
                    param_group["warmup_initial_lr"]
                    + warmup_factor * param_group["warmup_diff"]
                )
