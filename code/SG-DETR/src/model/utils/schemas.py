...
class DetectorOutput(BaseModel):
    ...
    route_logits: Optional[Tensor] = Field(None, description="soft length-routing logits. [layers, bs, queries, K]")
    query_length_prior_logits: Optional[Tensor] = Field(
        None,
        description="sample-level length-prior logits. [layers, bs, 1, K]",
    )
    duration_safety_prior_logits: Optional[Tensor] = Field(
        None,
        description="sample-level absolute-duration logits. [layers, bs, 1, K]",
    )
    query_prior_safety_logits: Optional[Tensor] = Field(
        None,
        description="sample-level prior safety-gate logits. [layers, bs, 1, 1]",
    )
    expert_quality_scores: Optional[Tensor] = Field(
        None,
        description="per-expert IOU logits. [layers, bs, queries, K]",
    )
    base_quality_scores: Optional[Tensor] = Field(
        None,
        description="detached baseline IOU logits before expert calibration. [layers, bs, queries, 1]",
    )
    base_class_scores: Optional[Tensor] = Field(
        None,
        description="detached baseline class logits before expert calibration. [layers, bs, queries, 1]",
    )
    expert_quality_residuals: Optional[Tensor] = Field(
        None,
        description="per-expert IOU-logit calibration residuals. [layers, bs, queries, K]",
    )
    uniform_class_scores: Optional[Tensor] = Field(
        None,
        description="uniform-expert counterfactual class logits. [layers, bs, queries, 1]",
    )
    uniform_quality_scores: Optional[Tensor] = Field(
        None,
        description="uniform-expert counterfactual quality logits. [layers, bs, queries, 1]",
    )
    safety_class_scores: Optional[Tensor] = Field(
        None,
        description="gate-only counterfactual class logits. [layers, bs, queries, 1]",
    )
    safety_quality_scores: Optional[Tensor] = Field(
        None,
        description="gate-only counterfactual quality logits. [layers, bs, queries, 1]",
    )
    route_gate_scores: Optional[Tensor] = Field(
        None,
        description="query-level soft route gate. [layers, bs, queries, 1]",
    )
    base_route_gate_scores: Optional[Tensor] = Field(
        None,
        description="route gate before sample-level attenuation. [layers, bs, queries, 1]",
    )
    sample_route_gate_logits: Optional[Tensor] = Field(
        None,
        description="sample-level route utility gate logits. [layers, bs, 1, 1]",
    )
    route_delta_scores: Optional[Tensor] = Field(
        None,
        description="routed-minus-uniform expert residual. [layers, bs, queries, 1]",
    )
