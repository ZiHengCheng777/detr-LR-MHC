...
from cg_detr.adaptive_soft_lrmhc import (
    AdaptiveSoftLRMHC,
...
class SetCriterion(nn.Module):
    ...
    def __init__(self, matcher, weight_dict, eos_coef, losses, temperature, span_loss_type, max_v_l,
                 saliency_margin=1, use_matcher=True, args=None, clip_length=2.0,
    ...
    def loss_spans(self, outputs, targets, indices):
        ...
        if (
            ...
            and 'route_prototypes' in outputs
            ...
            safe_loss = self.span_improvement_temperature * F.softplus(
                (corrected_cost - base_cost) / self.span_improvement_temperature
            )
