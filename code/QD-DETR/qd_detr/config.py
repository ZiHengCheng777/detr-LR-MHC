...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--dset_name", type=str, choices=["hl", "charadesSTA", 'tvsum'])
        ...
        parser.add_argument('--use_lrmhc', action='store_true')
        parser.add_argument('--lrmhc_uniform', action='store_true')
        parser.add_argument('--lrmhc_content_routing', action='store_true')
        parser.add_argument('--lrmhc_hard_routing', action='store_true')
        parser.add_argument('--lrmhc_fixed_prototypes', action='store_true')
        parser.add_argument('--lrmhc_no_gate', action='store_true')
        parser.add_argument('--lrmhc_width_no_detach', action='store_true')
        parser.add_argument('--lrmhc_route_beta', default=1.0, type=float)
        parser.add_argument('--lrmhc_prototypes', default=(-3.1781, -2.1253, -1.3863),
                            type=float, nargs=3)
        parser.add_argument('--lrmhc_gate_init', default=0.5, type=float)
        parser.add_argument('--lrmhc_router_hidden_dim', default=64, type=int)
        parser.add_argument('--lrmhc_router_logit_limit', default=0.0, type=float)
        parser.add_argument('--lrmhc_residual_limit', default=0.0, type=float)
        parser.add_argument('--lrmhc_lr_mult', default=10.0, type=float)
        parser.add_argument('--lrmhc_prototype_lr_mult', default=1.0, type=float)
        parser.add_argument('--lrmhc_route_loss_coef', default=0.0, type=float)
        parser.add_argument('--lrmhc_expert_rank_loss_coef', default=0.2, type=float)
        parser.add_argument('--lrmhc_routed_rank_loss_coef', default=0.5, type=float)
        parser.add_argument('--lrmhc_duration_balance_loss_coef', default=0.0, type=float)
        parser.add_argument('--lrmhc_duration_boundaries', default=(10.0, 30.0),
                            type=float, nargs=2)
        parser.add_argument('--lrmhc_duration_softness', default=2.0, type=float)
        parser.add_argument('--lrmhc_prototype_responsibilities', action='store_true')
        parser.add_argument('--lrmhc_query_gate', action='store_true')
        parser.add_argument('--lrmhc_query_gate_hidden_dim', default=32, type=int)
        parser.add_argument('--lrmhc_query_gate_init', default=0.2, type=float)
        parser.add_argument('--lrmhc_route_confidence_gate', action='store_true')
        parser.add_argument('--lrmhc_query_gate_oracle_loss_coef', default=0.0, type=float)
        parser.add_argument('--lrmhc_quality_rank_loss_coef', default=0.0, type=float)
        parser.add_argument('--lrmhc_balanced_quality_rank_loss_coef', default=0.0, type=float)
        parser.add_argument('--lrmhc_group_robust_temperature', default=0.0, type=float)
        parser.add_argument('--lrmhc_output_scale', default=1.0, type=float)
        parser.add_argument('--lrmhc_span_refine', action='store_true')
        parser.add_argument('--lrmhc_span_output_scale', default=0.1, type=float)
        parser.add_argument('--lrmhc_span_expert_scales', default=(1.0, 1.0, 1.0),
                            type=float, nargs=3)
        parser.add_argument('--lrmhc_span_short_guard', action='store_true')
        parser.add_argument('--lrmhc_span_short_guard_init', default=0.9, type=float)
        parser.add_argument('--lrmhc_span_short_guard_boundary', default=10.0, type=float)
        parser.add_argument('--lrmhc_span_short_guard_softness', default=2.0, type=float)
        parser.add_argument('--lrmhc_span_query_gate', action='store_true')
        parser.add_argument('--lrmhc_span_query_gate_hidden_dim', default=32, type=int)
        parser.add_argument('--lrmhc_span_query_gate_init', default=0.1, type=float)
        parser.add_argument('--lrmhc_span_query_gate_loss_coef', default=0.0, type=float)
        parser.add_argument('--lrmhc_span_query_gate_temperature', default=0.05, type=float)
        parser.add_argument('--lrmhc_train_span_only', action='store_true')
        parser.add_argument('--lrmhc_span_improvement_loss_coef', default=0.0, type=float)
        parser.add_argument('--lrmhc_span_improvement_temperature', default=0.05, type=float)
        parser.add_argument('--lrmhc_isolate_base_grad', action='store_true')
        parser.add_argument('--lrmhc_freeze_base', action='store_true')
        parser.add_argument('--lrmhc_beta_start', default=32.0, type=float)
        parser.add_argument('--lrmhc_beta_end', default=1.0, type=float)
        parser.add_argument('--lrmhc_beta_anneal_fraction', default=0.4, type=float)
