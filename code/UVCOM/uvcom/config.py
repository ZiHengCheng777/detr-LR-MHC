...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument(
            '--lrmhc_prototypes', default=(-3.1781, -2.1253, -1.3863),
            type=float, nargs=3
        )
        ...
        parser.add_argument('--lrmhc_eval_output_scale', default=None, type=float)
        parser.add_argument('--lrmhc_output_scale_start', default=None, type=float)
        parser.add_argument('--lrmhc_output_scale_ramp_start_epoch', default=0, type=int)
        parser.add_argument('--lrmhc_output_scale_ramp_epochs', default=1, type=int)
        ...
        parser.add_argument('--lrmhc_eval_span_output_scale', default=None, type=float)
        parser.add_argument('--lrmhc_span_output_scale_start', default=None, type=float)
        parser.add_argument('--lrmhc_span_output_scale_ramp_start_epoch', default=0, type=int)
        parser.add_argument('--lrmhc_span_output_scale_ramp_epochs', default=1, type=int)
        parser.add_argument(
            '--lrmhc_span_expert_scales', default=(1.0, 1.0, 1.0),
            type=float, nargs=3
        )
        ...
        parser.add_argument('--lrmhc_beta_start', default=4.0, type=float)
